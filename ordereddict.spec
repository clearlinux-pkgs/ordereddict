...
pushd ..
cp -a ordereddict-1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695929426
...
cp %{_builddir}/ordereddict-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/ordereddict/38abaf3c887f1799769b604e6d1ada4fcb81f8a0 || :
